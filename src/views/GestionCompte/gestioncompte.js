...
import { VerifPassword, updateuser } from 'src/services/UserService'
...
const Gestioncompte = () => {
  ...
  const changerpassword = (e) => {
    ...
    console.log('bdiyna', e.old_password)
                ...
                <div className="card-content">
                  <Form>
                    <div className="conteneur">
                      <div className="field gauche " style={{ marginRight: '10px' }}>
                          ...
                          <div className="field">
                            <div className="control">
                              <Field
                                ...
                                className={
                                  'input' + (errors.nom && touched.nom ? ' is-invalid' : '')
                                }
                              />
                              <ErrorMessage
                    ...
                    <div className="field">
                      ...
                      <div className="control">
                        <Field
                          ...
                          className={
                            'input is-static' + (errors.email && touched.email ? ' is-invalid' : '')
                          }
                        />
